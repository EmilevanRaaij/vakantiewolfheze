...
$tekst = json_decode(getData("http://vakantiewolfheze.nl/admin/api/collections/get/maincontent?token=ae65b98efa82723b2166ed29191b5a"))->entries[1];
    ...
    <div class="page">
        ...
        <nav role="navigation">
          <div id="menuToggle">
            ...
            <ul id="menu">
              ...
              <li>
              <div class="langicon">
                <a href="index.php"><p>EN</p><img src="icons/united-kingdom.png"></a>
                <div class="dropdown-content">
                  <a href="en.php"><p>EN</p><img src="icons/united-kindom.png" alt="NL"></a>
                  <a href="index.php"><p>NL</p><img src="icons/netherlands.png" alt="EN"></a>
                </div>
              </div>
              </li>
            </ul>
      ...
      <div class="section-dark">
        <div class="content">
          ...
          <div class="beschikbaarheid-wrapper">
            ...
            <button onclick="res_popup(1)" class="btn">Book</button>
          </div>   
        </div>
          ...
          <div class="activiteiten_container">
            <div class="activiteit-categorie">
              ...
              <div class="activiteit-categorie-onderschrift">
                ...
                <button id="restaurants-btn" onClick="toggleActivity(0)" class="btn">Read more</button>
              </div>
            ...
            <div class="activiteit-categorie">
              ...
              <div class="activiteit-categorie-onderschrift">
                ...
                <button id="steden-btn" onClick="toggleActivity(1)" class="btn">Read more</button>
              </div>
            </div><!--activiteit-categorie-->
            <div class="activiteit-categorie">
              ...
              <div class="activiteit-categorie-onderschrift">
                ...
                <button id="musea-btn" onClick="toggleActivity(2)" class="btn">Read more</button>
              </div>
            </div><!--activiteit-categorie-->
            <div class="activiteit-categorie">
              <img src="<?php echo($shared->activiteit_natuur_afbeelding->path) ?>">
              <div id="natuur-list" class="activiteiten-lijst">
                <p>cycling and hiking maps available in the chalet</p>
                <?php
                foreach($activiteiten as $act){
              ...
              <div class="activiteit-categorie-onderschrift">
                ...
                <button id="natuur-btn" onClick="toggleActivity(3)" class="btn">Read more</button>
              </div>
            </div><!--activiteit-categorie-->
          </div>
        </div>
      ...
      <div class="section-dark">
        <div class="content">
          ...
          if($r > 2){
            echo(
              '<button id="reviewbtn" onClick="reviewToggle()" class="btn">Read more</button>'
            );
          }
          ?>
        </div>
          ...
          <div class="split">
            ...
            <div id="contact_form">
              ...
              <form action="handler.php" method="post">
                <input type="text" placeholder="Name" class="forminput" required name="name">
                <input type="email" placeholder="E-mail" class="forminput" required name="email">
                <textarea name="message" id="" cols="30" rows="5" class="forminput" placeholder="Message" required></textarea name="message">
                <input type="submit" value="Send" class="forminput btn" id="formsubmit1">
              </form>
              </div>
            </div><!--contact_form-->
          </div><!--class split-->
      ...
      <div class="reservation-card" id="res-card">
        <div id="res-btn-wrapper">
          <button id="reservation-up-button" onClick="res_popup(1)">Book</button>
        </div>
        <div id="res-form-wrapper">
          <form action="#" onsubmit="return false">
            <input autocomplete="off" type="daterange" name="date" id="litepicker2" class="forminput res-form-input-wide" placeholder="From - to">
            <label for="peopleamount" class="formlabel res-form-label">Number of guests:</label>
            ...
            <br>
            <label class="formlabel res-form-label" for="pricetag">Price:</label>
            <input class="forminput res-form-input" type="text" id="pricetag" disabled>
            <input type="submit" onClick="bookingModalToggle(1)" class="forminput btn" value="Book"></input>
          </form>
        </div>
      </div>
    </div><!--page--> 
    <div class="modals">
        ...
        <div class="bookingmodal" id="bookingmodal">
          <div class="modalinner">
            ...
            <p>After submitting your reservation you will receive an invoice from us. You can cancel free of charge up to 14 days before arrival.</p>
              <form action="bookinghandler_en.php" method="post" id="main-booking-form">
                <input name="pr" class="hidden" type="text" id="pr">
                <input type="text" name="fname" id="fname" class="forminput res-form-input" placeholder="First name" required>
                <input type="text" name="sname" id="sname" class="forminput res-form-input" placeholder="Last name" required>
                <input type="email" name="email" id="email" class="forminput res-form-input-wide" placeholder="E-mail" required>
                <input type="daterange" name="date" id="litepicker3" class="forminput res-form-input-wide" placeholder="From To" required>
                <input type="text" name="straat" id="straat" class="forminput res-form-input-small" placeholder="Street" required>
                <input type="number" name="huisnr" id="huisnr" class="forminput res-form-input-small" placeholder="House number" required>
                <input type="text" name="postcode" id="postcode" class="forminput res-form-input-small" placeholder="Postal code" required>
                <input type="text" name="land" id="land" class="forminput res-form-input-small" placeholder="Country" required>
                <input type="text" name="telnr" id="telnr" class="forminput res-form-input-small" placeholder="Phone number" required>
                <select class="forminput res-form-input-small" name="peopleamount2" id="peopleamount2">
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
                </select>
                <textarea name="message" id="res-message" cols="30" rows="5" class="forminput res-form-input" placeholder="Message"></textarea>
                <div id="formdiv1">
                  <label class="formlabel res-form-label" for="pricetag2">Price:</label>
                  <input name="pricetag2" class="forminput res-form-input" type="text" id="pricetag2" disabled>
                  <input type="submit" value="Book" class="btn" id="btn3">
                </div>
              </form>
            </div>
          </div>
